...
% Import the data
Schaeferlhvertexnodes = readtable("/Users/sara/Downloads/Schaefer500_lh_vertexnodes.xlsx", opts, "UseExcel", false);
...
% Import the data
Schaeferrhvertexnodes = readtable("/Users/sara/Downloads/Schaefer500_rh_vertexnodes.xlsx", opts, "UseExcel", false);
...
% Import the data
Schaefermetadata = readtable("/Users/sara/Downloads/Schaefer500_metadata.xlsx", opts, "UseExcel", false);
% Clear temporary variables
clear opts
Schaefermetadata(1,:) = [];
...
for ii= 1:length(subs)
    ...
    %% save timepoints
    save(['/Users/sara/Desktop/02_Data/' sub '/Schaefer500_sortedtimepointswnetworks.mat'], 'sortedtp');
    
    %% run correlation on sorted matrix
    r = corrcoef(sortedtp'); % Correlation matrix
    z = 0.5 * log((1+r)./(1-r)); % Fisher-z transform
    %save the z-matrix
    save(['/Users/sara/Desktop/02_Data/' sub '/sch500_funccorrsorted_zmatrix.mat'], 'z');
    %remove negative z values and save
    individualcorrpossort = max(0, z);
    save(['/Users/sara/Desktop/02_Data/' sub '/' sub 'sch500_funccorrsorted_zmatrix_posonly.mat'], 'individualcorrpossort');
...
save('/Users/sara/Desktop/ScanTP1_sch500_meanfunccorrpos.mat', 'meancorrA');
save('/Users/sara/Desktop/ScanTP2_sch500_meanfunccorrpos.mat', 'meancorrB');
FigA=imagesc(meancorrA)
FigB=imagesc(meancorrB)

%create sorted metadata
sortedmeta = Schaefermetadata(netorder,:);
writetable(sortedmeta, '/Users/sara/Desktop/Shaefer500_sortedmetadata.xlsx');
