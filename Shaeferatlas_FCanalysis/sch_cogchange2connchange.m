...
lh=['/Users/sara/Desktop/surface_analysis_sch/lh.paired-diff.mgh'];
rh=['/Users/sara/Desktop/surface_analysis_sch/rh.paired-diff.mgh'];
lh=load_mgh(lh);
rh=load_mgh(rh);
lh=squeeze(lh);
rh=squeeze(rh);
...
dpath=['/Users/sara/Desktop/surface_analysis_sch/'];
